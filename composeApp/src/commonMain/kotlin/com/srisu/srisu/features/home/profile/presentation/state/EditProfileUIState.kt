...
data class EditProfileUIState(
    ...
    val largePhotos: List<com.srisu.srisu.features.home.profile.presentation.state.GalleyPhotoModel?>? =
        listOf(
    ...
    val smallPhotos: List<com.srisu.srisu.features.home.profile.presentation.state.GalleyPhotoModel?>? =
        listOf(
            _root_ide_package_.com.srisu.srisu.features.home.profile.presentation.state.GalleyPhotoModel(
                photoUri = null,
                index = 0
...
data class InterestCategoryUI(
    val category: String,
    val interests: List<com.srisu.srisu.features.home.profile.presentation.state.InterestUI>
)
